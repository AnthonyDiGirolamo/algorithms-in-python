...
if __name__ == '__main__':
    ...
    print("python sorted():")
    print(timeit.timeit('data = random_data() ; sorted(data)', setup="from __main__ import random_data", number=3))
    ...
    print("heapsort:")
    print(timeit.timeit('data = random_data() ; heapsort(data)', setup="from __main__ import random_data ; from heapsort import heapsort, heapify, sift_down", number=3))
